...
\begin{enumerate}
\item First step is to go on the \href{http://www.aispace.org/}{application site}
\item Then you need to go on download part of the site.
\item Under Belief and Decision Networks you should download the latest version[jar download].
\end{enumerate}
\end{minipage}}}\\

\begin{itemize}
\item
	\tab Some notes, you should have java installed prior to  running the application, otherwise it won't work.\\
...
The teaching objectives for this week are:
\begin{enumerate}
 \item To run and understand the some examples made by me.
\item To identify what realistic problems are adequate for my tool. 
\end{enumerate}
\end{minipage}}}
\input{runningexamples}
